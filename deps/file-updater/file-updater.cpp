// Forked and moodified from OBS @ deps/file-updater
#include <util/curl/curl-helper.h>
#include <util/platform.h>
#include <util/darray.h>
#include <util/dstr.h>
#include <obs-data.h>
#include "file-updater.hpp"
...
{
	struct file_update_data *input = (struct file_update_data *)param;
...
static bool update_files_to_local(void *param, obs_data_t *local_file)
{
	...
	data.name = obs_data_get_string(local_file, "name");
	data.version = (int)obs_data_get_int(local_file, "version");
...
static bool update_remote_files(void *param, obs_data_t *remote_file)
{
	...
	struct file_update_data data = {};
	data.name = obs_data_get_string(remote_file, "name");
	data.version = (int)obs_data_get_int(remote_file, "version");
				  ...
				  void *param)
{
	...
	info = (struct update_info *)bzalloc(sizeof(*info));
